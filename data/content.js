...
const content = {
  ...
  alumni: {
    ...
    items: [
      ...
      {
        name: { ko: 'Alumni B', en: 'Alumni B' },
        degree: { ko: '학사 졸업', en: 'B.S. Graduate' },
        period: '2025\u20132026',
        labRole: { ko: '데이터 전처리 및 검증', en: 'Data Preprocessing & Validation' },
        placement: { ko: '대기업 데이터 분석팀 \u2014 placeholder', en: 'Major Corp. Data Analytics Team \u2014 placeholder' },
        placementType: { ko: '산업체 취업', en: 'Industry' },
        quote: {
          ko: '학부 연구원으로 참여하면서 실무적인 데이터 처리 역량을 쌓을 수 있었고, 이 경험이 취업 과정에서 큰 강점이 되었습니다. \u2014 placeholder',
          en: 'As an undergraduate researcher, I built practical data processing skills that became a major strength in my job search. \u2014 placeholder',
        },
      },
      {
        name: { ko: 'Alumni C', en: 'Alumni C' },
        degree: { ko: '석사 졸업', en: 'M.S. Graduate' },
        period: '2024\u20132025',
        labRole: { ko: '데이터 거버넌스 연구', en: 'Data Governance Research' },
        placement: { ko: '해외 대학원 박사과정 \u2014 placeholder', en: 'Overseas Ph.D. Program \u2014 placeholder' },
        placementType: { ko: '대학원 진학', en: 'Graduate School' },
        quote: {
          ko: '연구소의 체계적인 데이터 거버넌스 경험이 해외 대학원 지원에서 차별화된 포인트가 되었습니다. \u2014 placeholder',
          en: 'The systematic data governance experience at the lab became a differentiating point in my overseas graduate school applications. \u2014 placeholder',
        },
      },
      {
        name: { ko: 'Alumni D', en: 'Alumni D' },
        degree: { ko: '학사 졸업', en: 'B.S. Graduate' },
        period: '2025\u20132026',
        labRole: { ko: '기업 수준 데이터 처리', en: 'Firm-level Data Processing' },
        placement: { ko: '데이터 분석 스타트업 \u2014 placeholder', en: 'Data Analytics Startup \u2014 placeholder' },
        placementType: { ko: '산업체 취업', en: 'Industry' },
        quote: {
          ko: '실제 기업 데이터를 다루면서 데이터 전처리의 중요성을 깊이 이해하게 되었고, 현업에서도 이 경험을 적극 활용하고 있습니다. \u2014 placeholder',
          en: 'Working with real corporate data deepened my understanding of the importance of data preprocessing, and I actively apply this experience in my current work. \u2014 placeholder',
        },
      },
      {
        name: { ko: 'Alumni E', en: 'Alumni E' },
        degree: { ko: '석사 졸업', en: 'M.S. Graduate' },
        period: '2024\u20132026',
        labRole: { ko: '논문 데이터 분석', en: 'Publication Data Analysis' },
        placement: { ko: '국책 연구기관 \u2014 placeholder', en: 'National Research Institute \u2014 placeholder' },
        placementType: { ko: '연구기관', en: 'Research Institute' },
        quote: {
          ko: '연구소에서의 프로젝트 경험이 연구자로서의 기초 체력을 만들어 주었습니다. \u2014 placeholder',
          en: 'The project experience at the lab built my foundational strength as a researcher. \u2014 placeholder',
        },
      },
    ],
  },
